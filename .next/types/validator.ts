...
// Validate ../../src/app/api/iku/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/iku/[id]">> = Specific
  const handler = {} as typeof import("../../src/app/api/iku/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/iku/export/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/iku/export">> = Specific
  const handler = {} as typeof import("../../src/app/api/iku/export/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/iku/import/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/iku/import">> = Specific
  const handler = {} as typeof import("../../src/app/api/iku/import/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/iku/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/iku">> = Specific
  const handler = {} as typeof import("../../src/app/api/iku/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/users/password/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/users/password">> = Specific
  const handler = {} as typeof import("../../src/app/api/users/password/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
